                ...
                <div className="conact-section">
                    ...
                    <div className="row section-space--bottom--50">
                        <div className="col">
                            ...
                            <iframe title="google-map" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=IIIT%20Guwahati+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" allowFullScreen></iframe>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div className="contact-information">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <span className="text"><span>IIITG - 781015</span></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-telephone-outline" /></span>
                                    <span className="text"><a href="tel:1234567890">(+91) 9621552354</a><a href="tel:1234567890">(+91) 9516417798</a></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-email-outline" /></span>
                                    <span className="text"><a href="mailto:info@example.com">aaryan.gupta@iiitg.ac.in</a><a href="mailto:info@example.com">harsh.gupta@iiitg.ac.in</a></span>
                                </li>
                            </ul>
                        </div>
                        </div>
